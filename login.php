...
<body>
    <div class="bgimg">
        ...
        if (!isset($_SESSION['username'])) {
            ...
            <h1>Log In</h1>
            <form id="login-form" action="login_php.php" method="post">
                ...
                <a class="link" href="moderatorlogin.php">Moderator login</a>
            </form>
        </div>';
        } else {
            ...
            <br>
            <button class="button-3" onclick="logout()">Log out</button>
        </div>';
        }
        ?>
    </div>
    ...
    <script>
        ...
        document.getElementById('login-form').addEventListener('submit', function (event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'login_php.php', true);
            xhr.onload = function () {
                if (xhr.status === 200) {
                    var response = JSON.parse(xhr.responseText);
                    if (response.success) {
